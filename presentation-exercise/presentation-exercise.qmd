...
Most the variables are character variables. There are 1058 observations and 65 variables in this dataset.

I will first create a column related to side dishes response, filter out NA values, and then attempt to create a table
...
I will now attempt to create the same graph from the article using ggplot()
...
This is honestly the best I could do, I'm not sure who the author was able to group all these graphs so neatly into one.

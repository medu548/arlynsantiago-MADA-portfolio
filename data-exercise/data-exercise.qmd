...
The data this week comes from the appa R package created by Avery Robbins. The original data came from the Avatar Wiki, and the example code used to scrape this dataset is also covered on Avery's blog along with a quick exploration of the available data in a separate blog post.

...
Xylem Hu contributed to this exercise.
...
#| tbl-cap: "this table explores the impact of Height on Weight." 
#| echo: FALSE
resulttable1=readRDS("../../results/tables-files/resulttable1.rds")
knitr::kable(resulttable1)
```

The figure below demonstrates the impact of the Number of People in Household on Weight:

![](images/Number_of_People_in_Household-weight.png)

The figure below demonstrates the impact of the Number of People in Household on Height:

![](images/Number_of_People_in_Household-height-01.png)

## 4.2 Basic statistical analysis

```{r}
#| label: tbl-resulttable2
#| tbl-cap: "this table explores the impact of height on Weight and Gender." 
#| echo: FALSE
resulttable2=readRDS("../../results/tables-files/resulttable2.rds")
knitr::kable(resulttable2)
```

The figure below demonstrates the impact of the Age on Height ![](images/Age-height.png)
...
Example @tbl-resulttable1 shows a summary of a linear model fit.

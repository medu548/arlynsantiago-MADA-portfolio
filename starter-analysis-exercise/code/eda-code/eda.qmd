...
# Boxplot: HC_time vs. height

```{r}
p5 <- mydata %>% ggplot(aes(x=Height, y=HC_time)) + geom_boxplot() + geom_smooth(method='lm')
plot(p5)
figure_file = here("starter-analysis-exercise","results","figures","HC_time-height.png")
ggsave(filename = figure_file, plot=p5) 
```

# Scatterplot: HC_time vs. Weight

```{r}
p6 <- mydata %>% ggplot(aes(x=Weight, y=HC_time)) + geom_point() + geom_smooth(method='lm')
plot(p6)
figure_file = here("starter-analysis-exercise","results","figures","HC_time-weight.png")

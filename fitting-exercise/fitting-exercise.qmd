...
tibble_metrics <- tibble(truth = truth, estimate = estimate)

test_accuracy <- yardstick::accuracy(data = tibble_metrics, truth = truth, estimate = estimate) # learned that yardstick is a cool tool that kind of does the work for you using tidymodels
